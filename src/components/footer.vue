<template>
    ...
    <div class="container">
        ...
        <mt-tabbar v-model="selected"  >
          <mt-tab-item  v-for="(nav,idx) in navs" :key="nav.name" :id="nav.nid" @click.native="change(nav,idx,$event) "   :class="{active : activeIndex == idx}" ref='changeimg'>
          <!-- 小图标 -->
...
export default {
    ...
    created(){
    // console.log(6666,this.$route.name);
        // let currentidx='';
